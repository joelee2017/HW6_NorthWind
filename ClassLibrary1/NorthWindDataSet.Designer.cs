...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ClassLibrary1.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ", UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM dbo.Products where" +
                " UnitPrice between @priceA and @priceB";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@priceA", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@priceB", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByProductName(NorthWindDataSet.ProductsDataTable dataTable, string name) {
        ...
        public virtual NorthWindDataSet.ProductsDataTable GetDataByProductName(string name) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByUnitPrice(NorthWindDataSet.ProductsDataTable dataTable, global::System.Nullable<decimal> priceA, global::System.Nullable<decimal> priceB) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((priceA.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(priceA.Value));
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            if ((priceB.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(priceB.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual NorthWindDataSet.ProductsDataTable GetDataByUnitPrice(global::System.Nullable<decimal> priceA, global::System.Nullable<decimal> priceB) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((priceA.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(priceA.Value));
            }
